...
import LiveAuction from '../HomePage/LiveAuction'
  ...
  return (
    <div>
      ...
      <div className={classes.mainContainer}>
        <Typography className={classes.headTitle}>Auction</Typography>
...
export default ExploreLiveAuction